...
class Test(Command):
    name = "test"
    short_description = "testing codes. USAGE: atcoder-tool test c"
...
class New(Command):
    name = "new"
    short_description = "create new contest. USAGE: atcoder-tool new abcxxx"
    long_description = "create new contest"
...
class Login(Command):
    name = "login"
    short_description = "login to atcoder."
